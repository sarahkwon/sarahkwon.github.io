...
const AboutMe = () => {
  return (
    <div className="aboutMe_container">
      ...
      <p>Sem integer vitae justo eget. Porttitor massa id neque aliquam vestibulum. Nulla facilisi etiam dignissim diam quis. Sagittis purus sit amet volutpat consequat mauris nunc congue nisi. Suspendisse potenti nullam ac tortor vitae. Amet est placerat in egestas erat imperdiet sed. Amet cursus sit amet dictum sit amet justo. Enim diam vulputate ut pharetra sit amet aliquam id diam. Ornare arcu dui vivamus arcu felis bibendum ut. Eu ultrices vitae auctor eu augue ut lectus. Pretium vulputate sapien nec sagittis aliquam.</p>
    </div>
  )
}
